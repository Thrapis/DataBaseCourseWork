...
namespace MobileOperatorApplication.Repository
{
	public class PaymentRepository : IRepository<Payment>
	{
		...
		public IEnumerable<Payment> GetAll()
		{
			...
			string sql = $"C##BAA.Payment_Package.GetAllPayments";
		...
		public Payment Get(int id)
		{
			...
			string sql = $@"C##BAA.Payment_Package.GetPaymentById";
		...
		public int Insert(Payment item)
		{
			...
			string sql = $@"C##BAA.Payment_Package.InsertPayment";
		...
		public int Update(Payment item)
		{
			...
			string sql = $@"C##BAA.Payment_Package.UpdatePayment";
			provider.Connection.Query(sql, queryParameters, commandType: CommandType.StoredProcedure);
		...
		public int Delete(int id)
		{
			...
			string sql = $@"C##BAA.Payment_Package.DeletePayment";
			provider.Connection.Query(sql, queryParameters, commandType: CommandType.StoredProcedure);
